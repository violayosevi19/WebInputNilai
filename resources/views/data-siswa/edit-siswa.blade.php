        ...
        <div class="wrapper wrapper--w680">
            <div class="card card-4">
                <div class="card-body">
                    ...
                    <form method="POST" action="/siswa/{{$siswas->id}}/update">
                        @csrf
                        @method('put')
                        <div class="row row-space">
                            <div class="col-2">
                                <div class="input-group">
                                    ...
                                    <input class="input--style-4" type="text" name="nis" value="{{ old('nis',$siswas->nis) }}">
                                </div>
                            </div>
                            <div class="col-2">
                                <div class="input-group">
                                    <label class="label">Nama lengkap</label>
                                    <input class="input--style-4" type="text" name="nama_siswa" value="{{ old('nama',$siswas->nama_siswa) }}" >
                                </div>
                            </div>
                        </div>
                        <div class="row row-space">
                            <div class="col-2">
                                <div class="input-group">
                                    ...
                                    <div class="input-group-icon">
                                        <input class="input--style-4" type="email" name="email" value="{{ old('email',$siswas->email) }}" >
                                    </div>
                                </div>
                            </div>
                            <div class="col-2">
                                <div class="input-group">
                                    ...
                                    <div class="p-t-10">
                                        <label class="radio-container m-r-45">L
                                            <input type="radio" name="jenis_kelamin" value="L" @if($siswas->jenis_kelamin == 'L') checked @endif>
                                            <span class="checkmark"></span>
                                        </label>
                                        <label class="radio-container">P
                                            <input type="radio" name="jenis_kelamin" value="P" @if ($siswas->jenis_kelamin == 'P') checked @endif>
                                            <span class="checkmark"></span>
                                        </label>
                                    </div>
                                </div>
