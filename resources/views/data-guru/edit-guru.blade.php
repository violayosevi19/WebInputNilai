        ...
        <div class="wrapper wrapper--w680">
            <div class="card card-4">
                <div class="card-body">
                    ...
                    <form method="post" action="/guru/{{$gurus->id}}/update">
                        @csrf
                        @method('put')
                        <div class="row row-space">
                            <div class="col-2">
                                <div class="input-group">
                                    ...
                                    <input class="input--style-4" type="text" name="nip" value="{{ old('nip',$gurus->nip) }}">
                                </div>
                            </div>
                            <div class="col-2">
                                <div class="input-group">
                                    <label class="label">Nama lengkap</label>
                                    <input class="input--style-4" type="text" name="nama_guru" value="{{ old('nama_guru',$gurus->nama_guru) }}">
                                </div>
                            </div>
                        </div>
                        <div class="row row-space">
                            <div class="col-2">
                                <div class="input-group">
                                    ...
                                    <div class="input-group-icon">
                                        <input class="input--style-4" type="email" name="email" value="{{ old('email',$gurus->email) }}">
                                    </div>
                                </div>
                            </div>
                            <div class="col-2">
                                <div class="input-group">
                                    ...
                                    <div class="input-group-icon">
                                        <input class="input--style-4" type="text" name="no_hp" value="{{ old('no_hp',$gurus->no_hp) }}">
                                    </div>
                                </div>
                            </div>
                        </div>
